...
|-------------------------------------|-----------------|----------------|--------------|
| UnityEngine.ImageConversion (PNG)   | 3.61 ms         | 1.0x (基準)    | 152,839 B    |
| FastImageConversion PNG (image-rs)  | **0.54 ms**     | **6.7x 高速**  | 228,182 B    |
| FastImageConversion PNG (fpng)      | **0.56 ms**     | **6.4x 高速**  | 246,197 B    |
| FastImageConversion WebP (lossy, デフォルト設定) | **0.86 ms** | **4.2x 高速** | 4,360 B |
...
|-------------------------------------|-----------------|----------------|
| UnityEngine ImageConversion.LoadImage (PNG) | 1.78 ms | 1.0x (基準) |
| FastImageConversion PNG (image-rs)  | **0.58 ms**     | **3.1x 高速**  |
| FastImageConversion PNG (fpng)      | **0.72 ms**     | **2.5x 高速**  |
| FastImageConversion WebP            | **0.24 ms**     | **7.4x 高速**  |
